Dynamic (Object) Fields | Sui Documentation
...
## Fields versus object fields[​](#fields-versus-object-fields "Direct link to Fields versus object fields")
...
## Adding dynamic fields[​](#adding-dynamic-fields "Direct link to Adding dynamic fields")

Use the `add` function from the relevant Sui framework module to add dynamic fields:

**Dynamic field**

[crates/sui-framework/packages/sui-framework/sources/dynamic\_field.move](https://github.com/MystenLabs/sui/blob/main/crates/sui-framework/packages/sui-framework/sources/dynamic_field.move)
...
[crates/sui-framework/packages/sui-framework/sources/dynamic\_object\_field.move](https://github.com/MystenLabs/sui/blob/main/crates/sui-framework/packages/sui-framework/sources/dynamic_object_field.move)
...
## Accessing dynamic fields[​](#accessing-dynamic-fields "Direct link to Accessing dynamic fields")
...
## Removing a dynamic field[​](#removing-a-dynamic-field "Direct link to Removing a dynamic field")
...
## Deleting an object with dynamic fields[​](#deleting-an-object-with-dynamic-fields "Direct link to Deleting an object with dynamic fields")
...
Sui provides `Table` and `Bag` collections built using dynamic fields, but with additional support to count the number of entries they contain to protect against accidental deletion when non-empty. To learn more, see [Tables and Bags](/concepts/dynamic-fields/tables-bags).

## Related links[​](#related-links "Direct link to Related links")

•

[Dynamic fields](https://move-book.com/programmability/dynamic-fields.html)

Learn more about Dynamic Fields in The Move Book. The Move Book is a comprehensive guide to the Move programming language and the Sui blockchain.

•

[Dynamic Object Fields](https://move-book.com/programmability/dynamic-object-fields.html)

Learn more about Dynamic Object Fields in The Move Book.

•

[Table and Bag](/concepts/dynamic-fields/tables-bags)
...
* [Fields versus object fields](#fields-versus-object-fields)
* [Field names](#field-names)
* [Adding dynamic fields](#adding-dynamic-fields)
* [Accessing dynamic fields](#accessing-dynamic-fields)
* [Removing a dynamic field](#removing-a-dynamic-field)
* [Deleting an object with dynamic fields](#deleting-an-object-with-dynamic-fields)
