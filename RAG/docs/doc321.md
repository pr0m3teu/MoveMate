...
## Advantages of the new package management system[​](#advantages-of-the-new-package-management-system "Direct link to Advantages of the new package management system")
...
## Installing and running the new package manager[​](#installing-and-running-the-new-package-manager "Direct link to Installing and running the new package manager")
...
## Changes to the `Move.toml` file[​](#changes-to-the-movetoml-file "Direct link to changes-to-the-movetoml-file")
...
### No addresses section[​](#no-addresses-section "Direct link to No addresses section")
...
### `package` section[​](#package-section "Direct link to package-section")
...
### `dependencies` section[​](#dependencies-section "Direct link to dependencies-section")
...
### Git dependencies with short SHAs[​](#git-dependencies-with-short-shas "Direct link to Git dependencies with short SHAs")
...
### `environments` and `dep-replacements` sections[​](#environments-and-dep-replacements-sections "Direct link to environments-and-dep-replacements-sections")
...
### Environment-specific dependency fields[​](#environment-specific-dependency-fields "Direct link to Environment-specific dependency fields")
...
## CLI changes[​](#cli-changes "Direct link to CLI changes")
...
* [Advantages of the new package management system](#advantages-of-the-new-package-management-system)
* [Installing and running the new package manager](#installing-and-running-the-new-package-manager)
* [Changes to the `Move.toml` file](#changes-to-the-movetoml-file)
  + [No addresses section](#no-addresses-section)
  + [`package` section](#package-section)
  + [`dependencies` section](#dependencies-section)
  + [Git dependencies with short SHAs](#git-dependencies-with-short-shas)
  + [`environments` and `dep-replacements` sections](#environments-and-dep-replacements-sections)
  + [Environment-specific dependency fields](#environment-specific-dependency-fields)
