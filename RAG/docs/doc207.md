...
## Representing in-game objects on chain[​](#representing-in-game-objects-on-chain "Direct link to Representing in-game objects on chain")
...
### In-game currencies[​](#in-game-currencies "Direct link to In-game currencies")
...
* [Currency Standard](/standards/currency)
* [In-Game Currency](/guides/developer/coin/in-game-token)
...
* [Regulated Coin and Deny List](/guides/developer/coin/regulated)
* [Loyalty Tokens](/guides/developer/coin/loyalty)
* [Closed-Loop Token](/standards/closed-loop-token)

### Game features[​](#game-features "Direct link to Game features")
...
* [Create a Non-Fungible Token](/guides/developer/nft)
* [Soulbound assets](#soulbound-assets)
* [Game economies](#game-economies)
* [Sui Object Display](#sui-object-display)

### Dynamic assets[​](#dynamic-assets "Direct link to Dynamic assets")
...
[examples/tic-tac-toe/move/sources/owned.move](https://github.com/MystenLabs/sui/blob/main/examples/tic-tac-toe/move/sources/owned.move)
...
#### Creating assets[​](#creating-assets "Direct link to Creating assets")
...
#### Updating assets[​](#updating-assets "Direct link to Updating assets")
...
For more information on the computation of gas fees, see [Sui Gas Pricing](/concepts/tokenomics/gas-in-sui).

#### Composing assets[​](#composing-assets "Direct link to Composing assets")
...
[examples/move/dynamic\_fields/sources/example.move](https://github.com/MystenLabs/sui/blob/main/examples/move/dynamic_fields/sources/example.move)
...
#### Transfer to object[​](#transfer-to-object "Direct link to Transfer to object")
...
See [Transfer to Object](/guides/developer/objects/transfers/transfer-to-object) for more details on how to effectively transfer objects to other objects on Sui.

#### Deleting assets[​](#deleting-assets "Direct link to Deleting assets")

On Sui, you can delete an object if the smart contract allows the operation. If the correct smart contract function is present, then you can delete the object in a single transaction. This results in a gas-fee rebate, which happens whenever bytes are freed on chain. The transaction's gas payer receives a rebate to account for the future storage of the object no longer being necessary but having already been paid for. See the [Storage fund](/concepts/tokenomics#storage-fund) section in Tokenomics to learn more about rebates.

### Soulbound assets[​](#soulbound-assets "Direct link to Soulbound assets")
...
#### Implementation overview[​](#implementation-overview "Direct link to Implementation overview")
...
### Token economics (Tokenomics)[​](#token-economics-tokenomics "Direct link to Token economics (Tokenomics)")
...
To learn more about token vesting strategies, see [Token Vesting Strategies](/guides/developer/coin/vesting-strategies).
...
* Does your token need to be regulated? A regulated coin provides greater control over who has access to your token but comes at the cost of additional maintenance of a deny list. You can learn more about regulated tokens at [Regulated Coin and Deny List](/guides/developer/coin/regulated).
...
On Sui, owned objects are either freely transferable or non-transferable. To ensure royalties, Sui provides a standard called Kiosk. A kiosk is a shared object that restricts access to a single address or user. See [Sui Kiosk](/standards/kiosk) for an in-depth look at the Kiosk standard.
...
### Transfer policy[​](#transfer-policy "Direct link to Transfer policy")
...
Players can register unique names for their racer profiles and teams using SuiNS, like [speedster@suiforspeed.sui](mailto:speedster@suiforspeed.sui) or [dragonracer@suiforspeed.sui](mailto:dragonracer@suiforspeed.sui). This simplifies social interactions, team coordination, and improves the community aspect of the game.
...
[Create Currencies and Tokens](/guides/developer/currency)
...
[Asset Tokenization](/guides/developer/nft/asset-tokenization)
...
[NFT Rental Example](/guides/developer/nft/nft-rental)
...
[Kiosk Apps](/standards/kiosk-apps)
...
[zkLogin](/concepts/cryptography/zklogin)
...
[Sui Foundation blog](https://blog.sui.io/tag/gaming/)

Blog posts from the Sui Foundation with the `gaming` tag.

•

[Coin Flip](/guides/developer/app-examples/coin-flip)
...
[Blackjack](/guides/developer/app-examples/blackjack)

Learn Sui using an example implementation of the popular casino game Blackjack.

•

[Plinko](/guides/developer/app-examples/plinko)

Learn Sui through an example implementation of the popular casino game, Plinko.

•

[Mysticon Legends](https://github.com/MystenLabs/mysticon-legends)

GitHub repo for a blockchain-based game where players collect, train, and battle with mythical creatures called Mysticons.

•

[Web3 Mini Games built on Sui](https://mini-games.sui.io/)

A collection of mini games, to inspire the community of Sui.

* [Representing in-game objects on chain](#representing-in-game-objects-on-chain)
...
* [Game economies](#game-economies)
  + [GameFi](#gamefi)
  + [Token economics (Tokenomics)](#token-economics-tokenomics)
  + [Kiosk](#kiosk)
