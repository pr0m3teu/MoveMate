Transactions | Sui Documentation
...
## Transaction metadata[​](#transaction-metadata "Direct link to Transaction metadata")

Programmable transaction blocks have the following metadata fields:

* **Sender address:** The [address](/guides/developer/getting-started/get-address) of the user sending the transaction.
...
## Example of a transaction flow[​](#example-of-a-transaction-flow "Direct link to Example of a transaction flow")
...
## Limits on transactions, objects, and data[​](#limits-on-transactions-objects-and-data "Direct link to Limits on transactions, objects, and data")
...
* [Example of a transaction flow](#example-of-a-transaction-flow)
* [Limits on transactions, objects, and data](#limits-on-transactions-objects-and-data)