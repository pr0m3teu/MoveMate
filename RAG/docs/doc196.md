Ethereum -> Sui | Sui Documentation
...
| Mutate contract state | Sending transactions through compile time ABI interface. | Sending transaction through runtime [programmable transaction block](/concepts/transactions/prog-txn-blocks) (PTB) construction. |
...
For all types of ownership on Sui, see [Object Ownership](/guides/developer/objects/object-ownership).
...
## Mutating objects[​](#mutating-objects "Direct link to Mutating objects")
...
## Programmable transaction blocks[​](#programmable-transaction-blocks "Direct link to Programmable transaction blocks")
...
See [Programmable Transaction Blocks](/concepts/transactions/prog-txn-blocks) for details on PTBs.

## More comparison[​](#more-comparison "Direct link to More comparison")
...
[Move Concepts](/concepts/sui-move-concepts)
...
[Programmable Transaction Blocks](/concepts/transactions/prog-txn-blocks)
...
* [More comparison](#more-comparison)
