...
The remainder of this topic covers the semantics of the execution of the transaction commands. It assumes familiarity with the Sui object model and the [Move language](/concepts/sui-move-concepts).

## Transaction components[​](#transaction-components "Direct link to Transaction components")
...
## Inputs and results[​](#inputs-and-results "Direct link to Inputs and results")
...
### `Argument` structure and usage[​](#argument-structure-and-usage "Direct link to argument-structure-and-usage")
...
### Start of execution[​](#start-of-execution "Direct link to Start of execution")
...
### Argument usage rules[​](#arguments "Direct link to Argument usage rules")
...
#### Borrowing rules[​](#borrowing-rules "Direct link to Borrowing rules")
...
#### Special object handling[​](#special-object-handling "Direct link to Special object handling")
...
#### Pure value type checking[​](#pure-value-type-checking "Direct link to Pure value type checking")
...
### Pre-execution validation[​](#pre-execution-validation "Direct link to Pre-execution validation")
...
#### `TransferObjects`[​](#transferobjects "Direct link to transferobjects")
...
#### `SplitCoins`[​](#splitcoins "Direct link to splitcoins")
...
#### `MergeCoins`[​](#mergecoins "Direct link to mergecoins")
...
#### `MakeMoveVec`[​](#makemovevec "Direct link to makemovevec")
...
#### `MoveCall`[​](#movecall "Direct link to movecall")
...
For more details on upgrades, see [Upgrading Packages](/concepts/sui-move-concepts/packages/upgrade).

### End of execution[​](#end-of-execution "Direct link to End of execution")
...
#### Command 0: `SplitCoins(GasCoin, [Input(2)])`[​](#command-0-splitcoinsgascoin-input2 "Direct link to command-0-splitcoinsgascoin-input2")
...
#### Command 1: `MoveCall("some_package", "some_marketplace", "buy_two", ...)`[​](#command-1-movecallsome_package-some_marketplace-buy_two- "Direct link to command-1-movecallsome_package-some_marketplace-buy_two-")
...
#### Command 2: `TransferObjects([GasCoin, NestedResult(1, 0)], Input(0))`[​](#command-2-transferobjectsgascoin-nestedresult1-0-input0 "Direct link to command-2-transferobjectsgascoin-nestedresult1-0-input0")
...
#### Command 3: `MoveCall("sui", "tx_context", "sender", [], [])`[​](#command-3-movecallsui-tx_context-sender-- "Direct link to command-3-movecallsui-tx_context-sender--")

Calls `sender(ctx: &TxContext): address`. Returns sender's address.

**Changes:** New result: `[sender_address]`

#### Command 4: `TransferObjects([NestedResult(1, 1)], NestedResult(3, 0))`[​](#command-4-transferobjectsnestedresult1-1-nestedresult3-0 "Direct link to command-4-transferobjectsnestedresult1-1-nestedresult3-0")
...
#### End of execution checks[​](#end-of-execution-checks "Direct link to End of execution checks")
...
* [Inputs and results](#inputs-and-results)
  + [Inputs](#inputs)
  + [Results](#results)
  + [`Argument` structure and usage](#argument-structure-and-usage)
* [Execution](#execution)
  + [Start of execution](#start-of-execution)
