...
You can use Move to define, create, and manage programmable Sui objects representing user-level assets. Sui's object system is implemented by adding new functionality to Move while also imposing additional restrictions. See [Object Model](/guides/developer/objects/object-model) for more details.

## Move on Sui[​](#move-on-sui "Direct link to Move on Sui")

Move on Sui contains some important differences from Move on other blockchains. Sui takes advantage of Move's security and flexibility and enhances it with the features to vastly improve throughput, reduce delays in finality, and make Move programming more approachable. For full details, see the [Sui Smart Contracts Platform](/assets/files/sui-6251a5c5b9d2fab6b1df0e24ba7c6322.pdf) whitepaper.
...
## Key differences[​](#differences "Direct link to Key differences")
...
### Object-centric global storage[​](#global-storage "Direct link to Object-centric global storage")
...
### Addresses represent Object IDs[​](#object-ids "Direct link to Addresses represent Object IDs")
...
See [Address](https://move-book.com/reference/primitive-types/address.html) in The Move Book for an overview on addresses and refer to [object.move](/references/framework/sui-framework/sui_sui/object) in the Sui Framework for implementation details.

### Object with key ability, globally unique IDs[​](#global-unique "Direct link to Object with key ability, globally unique IDs")
...
### Module initializers[​](#module-initializers "Direct link to Module initializers")
...
Language reference for Move on Sui.
