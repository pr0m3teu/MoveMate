Sui Programmable Transaction Basics | Mysten Labs TypeScript SDK Docs
...
## [Observing the results of a transaction](#observing-the-results-of-a-transaction)
...
## [Passing inputs to a command](#passing-inputs-to-a-command)
...
[Edit on GitHub](https://github.com/MystenLabs/ts-sdks/blob/main/packages/docs/content/typescript/transaction-building/basics.mdx)

[SuiGrpcClient

Previous Page](/typescript/grpc)[Paying for Sui Transactions with Gas Coins

Next Page](/typescript/transaction-building/gas)

### On this page

[Observing the results of a transaction](#observing-the-results-of-a-transaction)[Transactions](#transactions)[Passing inputs to a command](#passing-inputs-to-a-command)[JavaScript values](#javascript-values)[Pure values](#pure-values)[Object references](#object-references)[Object helpers](#object-helpers)[Transaction results](#transaction-results)[Get transaction bytes](#get-transaction-bytes)