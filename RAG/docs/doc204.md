...
## Organization principles[​](#organization-principles "Direct link to Organization principles")
...
For this reason, the `Move.lock` file should always be part of the package (don't add it to the `.gitignore` file). Use the [automated address management](/concepts/sui-move-concepts/packages/automated-address-management) instead of the old `published-at` field in the manifest file.
...
### CRUD function names[​](#crud-function-names "Direct link to CRUD function names")
...
### Shared objects[​](#shared-objects "Direct link to Shared objects")
...
### Pure functions[​](#pure-functions "Direct link to Pure functions")
...
### Coin argument[​](#coin-argument "Direct link to Coin argument")
...
### Data storage in owned vs shared objects[​](#data-storage-in-owned-vs-shared-objects "Direct link to Data storage in owned vs shared objects")
...
### Admin capability[​](#admin-capability "Direct link to Admin capability")
...
* [Code Structure](#code-structure)
  ...
  + [Coin argument](#coin-argument)
  + [Access control](#access-control)
  + [Data storage in owned vs shared objects](#data-storage-in-owned-vs-shared-objects)
