Transaction Plugins | Mysten Labs TypeScript SDK Docs
...
## [Contents of a Transaction](#contents-of-a-transaction)
...
## [Serialization Plugins](#serialization-plugins)
...
## [Transaction Intents](#transaction-intents)
...
[Edit on GitHub](https://github.com/MystenLabs/ts-sdks/blob/main/packages/docs/content/typescript/plugins.mdx)

[Transaction Executors

Previous Page](/typescript/executors)[Migrate to version 0.38.0

Next Page](/typescript/migrations/0.38)

### On this page

[Contents of a Transaction](#contents-of-a-transaction)[Lifecycle of a Transaction](#lifecycle-of-a-transaction)[Serialization Plugins](#serialization-plugins)[Build Plugins](#build-plugins)[Transaction Intents](#transaction-intents)