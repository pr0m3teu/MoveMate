...
> If you're looking for The Move Reference, you can find it [here](/reference).The Move Reference | The Move Book
...
Move takes its cue from [Rust](https://www.rust-lang.org/) by using resource types with move (hence
the name) semantics as an explicit representation of digital assets, such as currency.GitHub - MystenLabs/move-book: The Move Book and The Move Reference
...
You can’t perform that action at this time.The Move Book
...
> If you're looking for The Move Reference, you can find it [here](/reference).Foreword | The Move Book
...
— Sam Blackshear, creator of MoveBefore We Begin | The Move Book
...
can skip this chapter and proceed to [the next one](/your-first-move/hello-world).Install Sui | The Move Book
...
* [Troubleshooting](#troubleshooting)Install MVR | The Move Book
...
* [Troubleshooting](#troubleshooting)Set Up Your IDE | The Move Book
...
* [Other (CLI)](#other-cli)Move 2024 | The Move Book
...
and improvements in the new edition.Hello, World! | The Move Book
...
* [Further Reading](#further-reading)Hello, Sui! | The Move Book
...
* [Conclusion](#conclusion)Concepts | The Move Book
...
basic concepts required to write Move programs on Sui.Package | The Move Book
...
* [Links](#links)Package Manifest | The Move Book
...
* [Further Reading](#further-reading)Address | The Move Book
...
* [Further Reading](#further-reading)Account | The Move Book
...
* [Further Reading](#further-reading)Transaction | The Move Book
...
* [Inputs](#inputs)
* [Commands](#commands)
* [Transaction Effects](#transaction-effects)Move Basics | The Move Book
...
[Using Objects](/storage/) chapter, however, it is recommended to start with this chapter first.Module | The Move Book
...
* [Further Reading](#further-reading)Comments | The Move Book
...
* [Whitespace](#whitespace)Primitive Types | The Move Book
...
* [Integer Types](#integer-types)
  ...
  + [Overflow](#overflow)
* [Further Reading](#further-reading)Address Type | The Move Book
...
* [Further Reading](#further-reading)Expression | The Move Book
...
* [Control Flow Expressions](#control-flow-expressions)Custom Types with Struct | The Move Book
...
* [Further Reading](#further-reading)Abilities: Introduction | The Move Book
...
* [Further Reading](#further-reading)Abilities: Drop | The Move Book
...
* [Further Reading](#further-reading)Importing Modules | The Move Book
...
* [Importing a Module from Another Package](#importing-a-module-from-another-package)Standard Library | The Move Book
...
* [Source Code](#source-code)Vector | The Move Book
...
* [Further Reading](#further-reading)Option | The Move Book
...
* [Further Reading](#further-reading)String | The Move Book
...
* [Further Reading](#further-reading)Control Flow | The Move Book
...
* [Further Reading](#further-reading)Enums and Match | The Move Book
...
* [Summary](#summary)
* [Further Reading](#further-reading)Constants | The Move Book
...
* [Links](#links)Aborting Execution | The Move Book
...
* [Further Reading](#further-reading)Functions | The Move Book
...
* [Further Reading](#further-reading)Struct Methods | The Move Book
...
* [Further Reading](#further-reading)Visibility Modifiers | The Move Book
...
* [Further Reading](#further-reading)Ownership and Scope | The Move Book
...
* [Further Reading](#further-reading)Abilities: Copy | The Move Book
...
* [Further Reading](#further-reading)References | The Move Book
...
* [Further Reading](#further-reading)Generics | The Move Book
...
* [Further Reading](#further-reading)Type Reflection | The Move Book
...
* [In practice](#in-practice)
* [Further Reading](#further-reading)Testing | The Move Book
...
* [Further Reading](#further-reading)Object Model | The Move Book
...
[Sui Documentation](https://docs.sui.io/concepts/object-model).Move - Language for Digital Assets | The Move Book
...
* [Summary](#summary)
* [Further Reading](#further-reading)Evolution of Move | The Move Book
...
* [Summary](#summary)
* [Further Reading](#further-reading)What is an Object? | The Move Book
...
* [Summary](#summary)
* [Further Reading](#further-reading)Ownership | The Move Book
...
* [Summary](#summary)
* [Next Steps](#next-steps)Fast Path & Consensus | The Move Book
...
* [Summary](#summary)Using Objects | The Move Book
...
continuing.Sui Verifier: Internal Constraint | The Move Book
...
return to this concept several times throughout the book.Ability: Key | The Move Book
...
* [Summary](#summary)
* [Next Steps](#next-steps)
* [Further Reading](#further-reading)Ability: Store | The Move Book
...
* [Further Reading](#further-reading)Storage Functions | The Move Book
...
* [Next Steps](#next-steps)UID and ID | The Move Book
...
* [Links](#links)Receiving as Object | The Move Book
...
* [Example](#example)
* [Use Cases](#use-cases)
* [Links](#links)Advanced Programmability | The Move Book
...
skills.Sui Framework | The Move Book
...
* [Exported Addresses](#exported-addresses)
* [Implicit Imports](#implicit-imports)
* [Source Code](#source-code)Transaction Context | The Move Book
...
* [Generating Unique Addresses](#generating-unique-addresses)Module Initializer | The Move Book
...
* [Next Steps](#next-steps)Pattern: Capability | The Move Book
...
* [Address Check vs Capability](#address-check-vs-capability)Epoch and Time | The Move Book
...
* [Epoch](#epoch)
* [Time](#time)
* [Testing](#testing)Collections | The Move Book
...
* [Summary](#summary)
* [Next Steps](#next-steps)Pattern: Wrapper type | The Move Book
...
* [Next Steps](#next-steps)Dynamic Fields | The Move Book
...
* [Next Steps](#next-steps)Dynamic Object Fields | The Move Book
...
* [Next Steps](#next-steps)Dynamic Collections | The Move Book
...
* [Summary](#summary)
* [Further Reading](#further-reading)Pattern: Witness | The Move Book
...
* [Summary](#summary)
* [Next Steps](#next-steps)One Time Witness | The Move Book
...
* [Summary](#summary)Publisher Authority | The Move Book
...
* [Next Steps](#next-steps)Object Display | The Move Book
...
* [Further Reading](#further-reading)Events | The Move Book
...
* [Event Structure](#event-structure)Pattern: Hot Potato | The Move Book
...
* [Summary](#summary)Binary Canonical Serialization | The Move Book
...
* [Summary](#summary)Advanced Move Usage | The Move Book
...
build system.Modes | The Move Book
...
* [See also](#see-also)Move 2024 Migration Guide | The Move Book
...
* [Method Aliases](#method-aliases)Upgradeability Practices | The Move Book
...
* [Versioning configuration with dynamic fields](#versioning-configuration-with-dynamic-fields)Building Against Limits | The Move Book
...
* [Maximum Number of Events](#maximum-number-of-events)Better Error Handling | The Move Book
...
* [Rule 3: Return `bool` Instead of `assert`](#rule-3-return-bool-instead-of-assert)Code Quality Checklist | The Move Book
...
* [Comments](#comments)
  ...
  + [Complex Logic? Leave a Comment `//`](#complex-logic-leave-a-comment-)Appendix A: Glossary | The Move Book
...
* [Abilities](#abilities)Appendix B: Reserved Addresses | The Move Book
...
* 0x403 - address of the DenyList system objectAppendix C: Transfer Functions | The Move Book
...
* [Party](#party)Appendix D: Publications | The Move Book
...
* [Resources: A Safe Language Abstraction for Money](https://arxiv.org/abs/2004.05106) by Sam
  ...
  Zohar.
* [Robust Safety for Move](https://arxiv.org/abs/2110.05043) by Marco Patrignani, Sam BlackshearAppendix E: Contributing | The Move Book
...
files for the book, written in mdBook format.Appendix F: Acknowledgements | The Move Book
...
similar learning experience to the Move community.GitHub - MystenLabs/move-book: The Move Book and The Move Reference
...
You can’t perform that action at this time.The Move Reference | The Move Book
...
Move takes its cue from [Rust](https://www.rust-lang.org/) by using resource types with move (hence
the name) semantics as an explicit representation of digital assets, such as currency.Foreword | The Move Book
